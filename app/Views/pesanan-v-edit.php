                ...
                <div class="card-body">
                    <form method="post" action="<?= site_url('admin/pesanan/edit/' . $pesanan->id) ?>" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="date" value="<?= $pesanan->estimation ?>" class="form-control">
                        </div>
...
<!-- <script src="<?= base_url() ?>/stisla-template/assets/js/page/forms-advanced-forms.js"></script> -->
