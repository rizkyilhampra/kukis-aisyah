...
class PesananModel extends Model
{
    ...
    public function mPesanan($idPesanan)
    {
        $queryRow = $this->db->query(
            'SELECT pesanan.id, user.name, products.title, products.category, pesanan.created_at, pesanan.updated_at, pesanan.status, pesan_products.jumlah FROM pesanan 
            INNER JOIN user ON pesanan.user_id=user.id
